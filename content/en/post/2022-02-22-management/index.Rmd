...
One solution was to work outside the University. I've never done that except for some voluntary activities still related to academic projects. As I had some experience using machine learning methods and I knew how to code ~~[well, sort of]~~ I applied to some local companies in order to see what were people doing those days.
...
With all that fast acquired experience I accepted a new job offer in a bigger company, where I worked as a full time data engineer. There I learned to work with different teams, different software and a whole new knowledge field for me: sales. 
...
I don’t consider this move as a “step back”. It is a realization of my objectives and a way to fulfill what brings joy to my life. My advice at this point is to not be too eager to get those promotions and become that high profile corporate title: maybe you will realize that you will prefer the path to it.
